...
import com.example.cinema.entity.searchFilm.SearchFilm
...
const val apiKeyForActor = "6a2d7029-a0b8-4c64-8469-25bf56208176"
...
object CinemaRetrofitObject {
    ...
    val actorAndWorkerFullInfoApi: ActorAndWorkerFullInfoApi =
        retrofit.create(ActorAndWorkerFullInfoApi::class.java)
...
interface CinemaApi {
    ...
    suspend fun getGenreWithCountryFilm(
    ...
    suspend fun getPopularFilm(
        @Query("type") year: String = "TOP_AWAIT_FILMS",
        @Query("page") page: Int = 1
    ): CinemaTop
...
interface CinemaFullInfoApi {
    ...
    @GET("v2.2/films/{filmId}/images")
    @Headers("X-API-KEY: $apiKey")
    suspend fun getListGalleryType(
