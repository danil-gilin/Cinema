...
sealed class AllFilmProfileState{
    data class Success(val list:List<FilmDB>,val name:String,val watchFilmId: List<Int>):
        AllFilmProfileState()
    data class SuccessHistory(val list:List<HistoryCollectionDB>,val name:String,val watchFilmId: List<Int>):
        AllFilmProfileState()
